  ...
  return (
    <div className="w-full h-screen px-4 flex flex-col items-center">
      ...
      <video
        ...
        loop
        playsInline
        className="text-black backdrop-opacity-75 relative w-full h-4/5 rounded-2xl object-cover z-[-1]"
      >
        <source src="/assets/heroVideo.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <div className="mx-auto absolute bottom-0 bg-white w-3/4 min-h-[100px] flex rounded-2xl shadow-[#D9D9D9]">
