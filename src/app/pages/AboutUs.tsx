...
const AboutUs = () => {
  return (
    <div className="md:px-6 pt-10 w-full">
      {/* Intro heading */}
      ...
      {/* Features + Carousel */}
      <div className="flex flex-col md:flex-row w-full justify-center text-center md:text-start mt-2 px-4 md:px-0">
        <div className="w-full md:w-1/2 pt-10 space-y-8">
