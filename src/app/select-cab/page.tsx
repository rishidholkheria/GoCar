...
const SelectCab = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <div className="w-1/3 h-full overflow-y-scroll scrollbar-hide">
        <div className="fixed w-1/3 h-[5vw] flex justify-start items-center bg-blue-950 p-3 text-white">
        ...
        <div className="mt-[6vw] mx-4 bg-gray-200 rounded-2xl px-5 py-3 flex justify-center items-center">
          <div className="w-4/5">
